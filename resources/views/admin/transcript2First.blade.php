    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><b><center>ADMIN Dashboard - Second Year First Semester Result</center></b></div>

                <div class="panel-body">
                  <form method="POST" action="{{route('transcript2FirstSubmit')}}" data-parsley-validate class="form-horizontal form-label-left">
